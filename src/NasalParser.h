...
class  NasalParser : public antlr4::Parser {
public:
  enum {
  ...
  enum {
    ...
    RuleExpressionStatement = 4, RuleReturnStatement = 5, RuleIfStatement = 6, 
    RuleElsifStatement = 7, RuleElseStatement = 8, RuleExpression = 9, RuleFunctionExpression = 10, 
    RuleParameterList = 11, RuleBlock = 12, RuleSimpleExpression = 13, RuleAssignmentExpression = 14, 
    RuleLiteral = 15, RuleBooleanLiteral = 16, RuleBinaryOperator = 17
  };

  explicit NasalParser(antlr4::TokenStream *input);

  NasalParser(antlr4::TokenStream *input, const antlr4::atn::ParserATNSimulatorOptions &options);

  ~NasalParser() override;
  ...
  public:
    ...
    BlockContext *block();
    std::vector<ElsifStatementContext *> elsifStatement();
    ElsifStatementContext* elsifStatement(size_t i);
  ...
  class  ElsifStatementContext : public antlr4::ParserRuleContext {
  public:
    ElsifStatementContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
  ...
  ElsifStatementContext* elsifStatement();
